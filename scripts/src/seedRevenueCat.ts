...
const PROJECT_NAME        = "My Digital Collections";
const APP_STORE_APP_NAME  = "My Digital Collections";
const APP_STORE_BUNDLE_ID = "com.mydigitalcollections.app";
...
const PRODUCTS: ProductDef[] = [
  {
    ...
    displayName: "Monthly – My Digital Collections",
    type:        "subscription",
    duration:    "P1M",
  ...
  },
  {
    ...
    displayName: "Yearly – My Digital Collections",
    type:        "subscription",
    duration:    "P1Y",
  ...
  },
  {
    ...
    displayName: "Lifetime – My Digital Collections",
    type:        "non_consumable",
