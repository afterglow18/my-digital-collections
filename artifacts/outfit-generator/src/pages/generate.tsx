/**
 * GeneratePage — "Spin It" screen for My Digital Collections.
 *
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        ...
                        height: 54, borderRadius: 28,
                        border: "2.5px solid #B8994E",
                        background: canSave ? "linear-gradient(to bottom, #EBD9A8, #C4AB72)" : "rgba(30,20,10,0.40)",
                        color: canSave ? "#5C3D0A" : "rgba(184,137,78,0.55)",
                        fontFamily: "var(--font-display)",
                        fontWeight: 800, fontSize: 14,
                        letterSpacing: "-0.01em", textTransform: "uppercase",
                        whiteSpace: "nowrap",
